    ...
    PalavraPresidentePage.prototype.getWordPresident = function () {
        ...
        if (this.data.length <= 0) {
            ...
            this.edicaoService.reqOthers(this.idEdition, 'wordPresident').then(function (dataWordPresident) {
                ...
                if (_this.data[0].author) {
                    _this.author.push({
                        name: _this.data[0].author.name,
                        info: _this.data[0].author.info,
                        photo: _this.data[0].author.photo
                    });
                }
                _this.loading.dismiss();
            }, function (erro) {
...
PalavraPresidentePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-palavra-presidente',template:/*ion-inline-start:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\tabs\edicao-atual-tab\palavra-presidente\palavra-presidente.html"*/'<ion-content>\n\n    <div class="TopInfo">\n\n        <div class="InfGer" padding>\n\n            <div class="TitCat">\n\n                #{{data[0]?.article}}\n\n            </div>\n\n            <div class="TitNot">\n\n               {{data[0]?.title}}\n\n            </div>\n\n            <div class="SubTitNot">\n\n                <p>{{data[0]?.caption}}</p>\n\n            </div>\n\n        </div>\n\n        <div class="InfSep"></div>\n\n        <div class="InfAut"  *ngFor="let item of author" padding>\n\n            <div class="InfAutAre">\n\n                <div class="InfAutThu">\n\n                     <img src="{{item?.photo}}" alt="" >\n\n                </div>\n\n            </div>\n\n            <div class="InfAutInf">\n\n                <div class="InfAutNom TitNot"  [innerHTML]="item?.name">\n\n                    \n\n                </div>\n\n                <div class="InfAutRes SubTitNot" [innerHTML]="item?.info">\n\n                    \n\n                </div>\n\n            </div>\n\n        </div>\n\n    </div>\n\n    <div class="ConGer" padding>\n\n        <div [innerHTML]="data[0]?.text"></div>\n\n    </div>\n\n</ion-content>'/*ion-inline-end:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\tabs\edicao-atual-tab\palavra-presidente\palavra-presidente.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* LoadingController */],
...
EspacoLeitorPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-espaco-leitor',template:/*ion-inline-start:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\tabs\edicao-atual-tab\espaco-leitor\espaco-leitor.html"*/'<ion-content padding>\n\n\n\n      <div class="TitCat">\n\n          #{{data[0]?.title}}\n\n      </div>\n\n  <div class="IteLei" [innerHtml]="data[0]?.text">\n\n\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\tabs\edicao-atual-tab\espaco-leitor\espaco-leitor.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* LoadingController */],
...
ExpedienteEdicaoPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-expediente-edicao',template:/*ion-inline-start:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\tabs\edicao-atual-tab\expediente-edicao\expediente-edicao.html"*/'<ion-content padding>\n\n    <div class="TitCat">\n\n        #{{data[0]?.title}}\n\n    </div>\n\n    <div class="ConGer" [innerHtml]="data[0]?.text">\n\n        \n\n    </div>\n\n</ion-content>'/*ion-inline-end:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\tabs\edicao-atual-tab\expediente-edicao\expediente-edicao.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* LoadingController */],
...
var TodasEdicoesPage = (function () {
    ...
    TodasEdicoesPage.prototype.getEditions = function () {
        ...
        this.edicaoServico.reqEditions().then(function (data) {
            ...
            _this.editions = array;
            console.log(_this.editions);
            _this.loading.dismiss();
        }, function (erro) {
            _this.loading.dismiss();
        });
...
OutrasEdicoesPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-edicao-atual',template:/*ion-inline-start:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\outras-edicoes\outras-edicoes.html"*/'<ion-header>\n\n    <ion-navbar color="primary" align-title="left">\n\n        <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n        <ion-title><img src="{{logoTopo}}" height="30px" class="logo_topo"> <span>{{edicao}}</span></ion-title>\n\n    </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content>\n\n\n\n\n\n    <ion-tabs color="primary">\n\n        <ion-tab tabTitle="{{SumEdicao}}" [root]="tab1" [rootParams]="{id: idEdi}"></ion-tab>\n\n        <ion-tab tabTitle="{{PalPresidente}}" [root]="tab2" [rootParams]="{id: idEdi}"></ion-tab>\n\n        <ion-tab tabTitle="{{EspLeitor}}" [root]="tab3" [rootParams]="{id: idEdi}"></ion-tab>\n\n        <ion-tab tabTitle="{{ExpEdicao}}" [root]="tab4" [rootParams]="{id: idEdi}"></ion-tab>\n\n    </ion-tabs>\n\n</ion-content>'/*ion-inline-end:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\outras-edicoes\outras-edicoes.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_6__providers_variaveis_globais_variaveis_globais__["a" /* VariaveisGlobaisProvider */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* LoadingController */],
...
SobreOAppPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-sobre-o-app',template:/*ion-inline-start:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\sobre-o-app\sobre-o-app.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n      <button ion-button menuToggle>\n\n    <ion-icon name="menu"></ion-icon>\n\n  </button>\n\n      <ion-title>{{data.title}}</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div [innerHtml]="data.content"></div>\n\n \n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Trinchao\Documents\Crea_ba\src\pages\sobre-o-app\sobre-o-app.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_2__providers_variaveis_globais_variaveis_globais__["a" /* VariaveisGlobaisProvider */],
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\Users\Trinchao\Documents\Crea_ba\src\app\app.html"*/'<ion-menu class="MeuMen" type="reveal" [content]="content">\n\n    <ion-header>\n\n        <ion-toolbar color="primary">\n\n            <ion-title>\n\n                <ion-icon menuClose name="arrow-back"></ion-icon> \n\n                \n\n                <img src="{{logoMenu}}" height="30px">\n\n            </ion-title>\n\n        </ion-toolbar>\n\n    </ion-header>\n\n\n\n    <ion-content>\n\n        <ion-list>\n\n            <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n        </ion-list>\n\n    </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\Trinchao\Documents\Crea_ba\src\app\app.html"*/,
